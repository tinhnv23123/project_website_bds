                    ...
                    <div class="card" id="customerList">
                        <div class="card-header border-bottom-dashed">
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-sm">
                                    <div>
                                        <h5 class="card-title mb-0">Danh sách loại bất động sản</h5>
                                    </div>
                                </div>
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="index.php?act=addloaibds"><button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Thêm mới loại</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table align-middle" id="customerTable">
                                        <thead class="table-light text-muted">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="customer_name">Tên loại</th>
                                                <th class="sort" data-sort="action">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody class="list form-check-all">
                                            <?php
                                            foreach ($listloaibds as $danhmuc) {
                                                extract($danhmuc);
                                                echo '<tr>
                                                <th scope="row">
                                            ...
                                            <td>
                                                ...
                                                <a href="index.php?act=sualoaibds&id=' . $id . '">
